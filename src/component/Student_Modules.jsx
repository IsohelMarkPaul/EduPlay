...
import MOCK_STUDENT_PROGRESS from "../Student_Data/MOCK_STUDENT_PROGRESS.json"

function Student_Modules() {
    const [moduleStates, setModuleStates] = useState([]);
    const [studentProgressData, setStudentProgressData] = useState(MOCK_STUDENT_PROGRESS);
